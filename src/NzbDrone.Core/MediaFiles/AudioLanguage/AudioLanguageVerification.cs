...
{
    /// <summary>
    /// Outcome of one audio-track language probe, stored on the movie file at import time
    /// (MovieFile.AudioLanguageVerification, JSON list). Written once by the import pipeline;
