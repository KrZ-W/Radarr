...
{
    /// <summary>
    /// Outcome of the post-import audio-track language retag, stored on the movie file
    /// (MovieFile.AudioTrackRetag, JSON). A file whose Result is "done" is never retagged again.
    /// </summary>
