    ...
    public class AudioLanguageTriggerPolicyFixture : CoreTest
    {
        ...
        public void Setup()
        {
            ...
            _input = new AudioLanguageTriggerInput
            {
                ...
                ProfileLanguage = Language.French,
        ...
        [Test]
        public void should_take_fast_path_when_profile_is_any_and_no_language_format()
        {
            _input.ProfileLanguage = Language.Any;
        ...
        [Test]
        public void should_still_evaluate_when_profile_is_any_but_a_language_format_exists()
        {
            _input.ProfileLanguage = Language.Any;
            _input.HasLanguageCustomFormat = true;
            _input.Tracks = new List<AudioTrackInfo> { Track(0, "und") };
        ...
        [Test]
        public void contradiction_should_ignore_any_original_and_unknown_claims()
        {
            _input.ClaimedLanguages = new List<Language> { Language.Any, Language.Original, Language.Unknown };
        ...
        public void impending_rejection_should_skip_tracks_tagged_with_a_custom_format_language()
        {
            _input.ProfileLanguage = Language.Any;
            _input.HasLanguageCustomFormat = true;
            _input.CustomFormatLanguages = new List<Language> { Language.French };
        ...
        [Test]
        public void impending_rejection_should_resolve_original_language_through_the_movie()
        {
            _input.ProfileLanguage = Language.Original;
        ...
        [Test]
        public void expected_languages_should_union_profile_and_positive_format_languages()
        {
            _input.ProfileLanguage = Language.Original;
            _input.OriginalLanguage = Language.English;
            _input.CustomFormatLanguages = new List<Language> { Language.French, Language.Original, Language.Any };
