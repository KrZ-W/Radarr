...
namespace NzbDrone.Core.Test.MediaFiles.AudioLanguage
{
    ...
    public class AudioLanguageVerificationMessageFixture : CoreTest
    {
        ...
        {
            AudioLanguageVerificationMessage.Describe(_localMovie, Language.French)
        ...
        {
            AudioLanguageVerificationMessage.Describe(_localMovie, null).Should().Be("Audio verified (detected en 0.97, en 0.94)");
        }

        [Test]
        public void should_mark_failed_probes()
        {
            _localMovie.AudioLanguageVerification[1].DetectedLanguage = null;

            AudioLanguageVerificationMessage.Describe(_localMovie, Language.French).Should().Contain("detected en 0.97, ?");
        }
        ...
        public void should_return_null_unless_a_rejection_trigger_fired(AudioLanguageTrigger trigger)
        {
            ...
            AudioLanguageVerificationMessage.Describe(_localMovie, Language.French).Should().BeNull();
        }
        ...
        public void should_return_null_without_results()
        {
            ...
            _localMovie.AudioLanguageVerification = null;
            AudioLanguageVerificationMessage.Describe(_localMovie, Language.French).Should().BeNull();
        }
    }
}
