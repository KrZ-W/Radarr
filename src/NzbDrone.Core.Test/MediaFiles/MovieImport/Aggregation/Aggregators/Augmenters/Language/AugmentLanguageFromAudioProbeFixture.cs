    ...
    public class AugmentLanguageFromAudioProbeFixture : CoreTest<AugmentLanguageFromAudioProbe>
    {
        ...
        public void Setup()
        {
            _movie = Builder<Movie>.CreateNew()
                .With(m => m.QualityProfile = new QualityProfile { Language = Core.Languages.Language.French, FormatItems = new List<ProfileFormatItem>(), MinFormatScore = 0 })
                .Build();
            _movie.MovieMetadata.Value.OriginalLanguage = Core.Languages.Language.English;
            ...
            {
                Path = "/downloads/Movie.2020.FRENCH.1080p-GRP/movie.mkv",
                Movie = _movie,
                MediaInfo = new MediaInfoModel { RawStreamData = "{}", RunTime = TimeSpan.FromHours(1.5) },
                FileMovieInfo = new ParsedMovieInfo { Languages = new List<Core.Languages.Language> { Core.Languages.Language.French }, ReleaseGroup = "GRP" }
            };
        ...
        public void should_return_detected_language_with_audio_probe_confidence_when_the_claim_contradicts_the_tag()
        {
            ...
            _localMovie.AudioLanguageTrigger.Should().Be(AudioLanguageTrigger.Contradiction);
            _localMovie.AudioLanguageVerification.Should().HaveCount(1);
            _localMovie.AudioLanguageVerification[0].StreamIndex.Should().Be(0);
            _localMovie.AudioLanguageVerification[0].TaggedLanguage.Should().Be("eng");
            _localMovie.AudioLanguageVerification[0].DetectedLanguage.Should().Be("fr");
            _localMovie.AudioLanguageVerification[0].Confidence.Should().Be(0.97);
            _localMovie.AudioLanguageVerification[0].Source.Should().Be("whisper");
            _localMovie.AudioLanguageVerification[0].ProbedAt.Should().BeCloseTo(DateTime.UtcNow, TimeSpan.FromMinutes(1));
        }
        ...
        public void should_keep_tags_of_tracks_that_were_not_probed()
        {
            ...
            _localMovie.AudioLanguageTrigger.Should().Be(AudioLanguageTrigger.Unknown);
            VerifyProbeCount(1);
        ...
        public void should_fall_through_below_threshold_but_still_record_the_outcome()
        {
            ...
            Subject.AugmentLanguage(_localMovie, _downloadClientItem).Should().BeNull();

            _localMovie.AudioLanguageVerification.Should().HaveCount(1);
            _localMovie.AudioLanguageVerification[0].Confidence.Should().Be(0.5);
        }
        ...
        public void should_fall_through_when_the_probe_fails()
        {
            ...
            _localMovie.AudioLanguageTrigger.Should().Be(AudioLanguageTrigger.Contradiction);
            _localMovie.AudioLanguageVerification.Should().HaveCount(1);
            _localMovie.AudioLanguageVerification[0].DetectedLanguage.Should().BeNull();
        }
        ...
        public void should_not_probe_when_disabled()
        {
            ...
            VerifyProbeCount(0);
            _localMovie.AudioLanguageVerification.Should().BeNull();
        }
        ...
        public void should_not_probe_existing_files_on_rescan()
        {
            ...
            Subject.AugmentLanguage(_localMovie, null).Should().BeNull();
        ...
        [Test]
        public void should_never_call_the_detector_when_profile_is_any_and_no_language_format_exists()
        {
        ...
        public void should_probe_once_per_layout_per_pack_and_reuse_for_other_files()
        {
            ...
            var first = Subject.AugmentLanguage(_localMovie, _downloadClientItem);

            var second = new LocalMovie
            {
                Path = "/downloads/Movie.2020.FRENCH.1080p-GRP/movie-cd2.mkv",
                Movie = _movie,
                MediaInfo = _localMovie.MediaInfo,
                FileMovieInfo = _localMovie.FileMovieInfo
            };
        ...
        {
            GivenProbe("fr", 0.97);
            Subject.AugmentLanguage(_localMovie, _downloadClientItem);
        ...
        public void should_key_the_cache_on_the_parent_folder_without_a_download_client_item()
        {
            ...
            Subject.AugmentLanguage(_localMovie, null);
            Subject.AugmentLanguage(_localMovie, null);
        ...
        public void should_take_the_claim_from_the_grab_history_row()
        {
            ...
            Mocker.GetMock<IHistoryService>()
                  ...
                  {
                      new MovieHistory { EventType = MovieHistoryEventType.Grabbed, Date = DateTime.UtcNow, Languages = new List<Core.Languages.Language> { Core.Languages.Language.French } }
                  });
            GivenProbe("fr", 0.97);
        ...
        [Test]
        public void should_use_language_custom_formats_for_the_expectation_when_profile_is_any()
        {
            _movie.QualityProfile.Language = Core.Languages.Language.Any;
