...
namespace NzbDrone.Core.Test.MediaFiles.MovieImport.Aggregation.Aggregators
{
    ...
    public class AggregateLanguageFixture : CoreTest<AggregateLanguage>
    {
        ...
        public void should_prefer_audio_probe_over_media_info_regardless_of_registration_order()
        {
            ...
            audioProbeAugmenter.Setup(s => s.AugmentLanguage(It.IsAny<LocalMovie>(), It.IsAny<DownloadClientItem>()))
        ...
        public void should_keep_media_info_when_audio_probe_falls_through()
        {
            ...
            Subject.Aggregate(_localMovie, null).Languages.Should().Equal(new List<Language> { Language.English });
        }
    }
}
