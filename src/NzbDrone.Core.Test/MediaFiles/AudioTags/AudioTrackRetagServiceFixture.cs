    ...
    public class AudioTrackRetagServiceFixture : CoreTest<AudioTrackRetagService>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IVideoFileInfoReader>()
                  ...
                  .Returns(() => new MediaInfoModel { AudioLanguages = _probedTags.ToList(), SchemaRevision = 14 });
        ...
        [Test]
        public void should_keep_every_language_of_a_multi_track_file()
        {
        ...
        [Test]
        public void should_fall_back_to_move_when_rename_is_unsupported()
        {
            GivenHardlinked();
            GivenMode(AudioTrackRetagHardlinkMode.CopyThenRetag);
            ...
            Mocker.GetMock<IDiskProvider>().Verify(d => d.MoveFile(TempPath, LibraryPath, true), Times.Once());
            _movieFile.AudioTrackRetag.Result.Should().Be(AudioTrackRetagResult.Done);
        }
