...
namespace NzbDrone.Core.Test.MediaFiles.AudioTags
{
    ...
    {
        private const string Path = "/movies/Movie (2020)/Movie (2020).mkv";
        ...
        public void should_build_one_edit_per_track_with_one_based_audio_numbers()
        {
            ...
            args.Should().Be("\"/movies/Movie (2020)/Movie (2020).mkv\" --edit track:a1 --set language=fre --edit track:a3 --set language=ger");
        }
        ...
        public void should_order_edits_by_stream_index()
        {
            ...
            args.Should().Be("\"/movies/Movie (2020)/Movie (2020).mkv\" --edit track:a2 --set language=ger --edit track:a4 --set language=fre");
        }
