...
namespace NzbDrone.Core.Test.MovieTests.ImdbTitleTests
{
    ...
    public class ImdbAkasTsvParserFixture : CoreTest
    {
        ...
        [TestCase("Amélie de Montmartre", "amelie de montmartre")]
        [TestCase("  (500) Jours avec SUMMER!  ", "500 jours avec summer")]
        [TestCase("L'Étrange Noël de M. Jack", "l etrange noel de m jack")]
        [TestCase("", "")]
        [TestCase(null, "")]
        [TestCase("!!!", "")]
