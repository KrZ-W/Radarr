...
|---|---|---|
| `6.3.0.10514-krzw.10` | a tagged release (immutable) | **production — pin to this** |
...
docker run -d --name radarr \
  ...
  ghcr.io/krz-w/radarr:6.3.0.10514-krzw.10
```
...
services:
  radarr:
    image: ghcr.io/krz-w/radarr:6.3.0.10514-krzw.10
